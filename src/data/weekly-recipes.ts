...
// ========== 第十周食谱 (3月1日周日 - 3月7日周六) ==========
const week10Recipes: Recipe[] = [
  { id: 'w10-braised-pork', name: '红烧肉', type: 'main', season: 'spring', flavor: 'rich',
    ingredients: [{ name: '五花肉', amount: '600g', category: 'meat', storageDays: 3 }],
    steps: ['五花肉切3cm方块，冷水下锅焯水5分钟捞出洗净', '锅中放少许油，下冰糖30g小火炒出糖色', '放入五花肉翻炒上色，加入葱段姜片八角桂皮', '加生抽2勺、老抽1勺、料酒2勺翻炒均匀', '加开水没过肉块，大火烧开转小火炖1小时', '大火收汁至浓稠，撒葱花出锅'],
    nutrition: { calories: 480, protein: 25, carbs: 15, fat: 38 }, cookTime: 80, difficulty: 'medium', tags: ['经典', '下饭'] },
  { id: 'w10-stir-bamboo', name: '油焖春笋', type: 'side', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '春笋', amount: '400g', category: 'vegetable', storageDays: 5 }],
    steps: ['春笋剥去外壳，切滚刀块', '烧开水加少许盐，下春笋焯烫3分钟去涩味捞出', '锅中放油烧热，下春笋中火煸炒3分钟至微黄', '加生抽1勺、老抽半勺、糖少许翻炒均匀', '加盖小火焖5分钟至入味', '大火收汁撒葱花出锅'],
    nutrition: { calories: 90, protein: 4, carbs: 15, fat: 2 }, cookTime: 20, difficulty: 'easy', tags: ['时令', '鲜嫩'] },
  { id: 'w10-steamed-fish', name: '清蒸多宝鱼', type: 'main', season: 'spring', flavor: 'light',
    ingredients: [{ name: '多宝鱼', amount: '1条', category: 'seafood', storageDays: 1 }],
    steps: ['多宝鱼去鳞去内脏洗净，两面划刀', '鱼身抹少许盐和料酒，铺姜片葱段腌制10分钟', '蒸锅水开后放入鱼，大火蒸10分钟', '倒掉蒸出的汤汁，捡去旧葱姜', '铺新鲜葱丝姜丝，淋蒸鱼豉油2勺', '热油3勺烧至冒烟泼在葱姜上'],
    nutrition: { calories: 200, protein: 35, carbs: 2, fat: 6 }, cookTime: 20, difficulty: 'easy', tags: ['清淡', '鲜美'] },
  { id: 'w10-garlic-spinach', name: '蒜蓉菠菜', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '菠菜', amount: '400g', category: 'vegetable', storageDays: 3 }],
    steps: ['菠菜去根洗净，切成10cm长段', '烧开水加少许油盐，下菠菜焯烫30秒捞出沥干', '蒜切末备用', '锅中放油烧热，下蒜末爆香10秒', '倒入菠菜快速翻炒30秒', '加盐少许调味出锅'],
    nutrition: { calories: 55, protein: 4, carbs: 6, fat: 2 }, cookTime: 8, difficulty: 'easy', tags: ['快手', '营养'] },
  { id: 'w10-kung-pao-chicken', name: '宫保鸡丁', type: 'main', season: 'spring', flavor: 'spicy',
    ingredients: [{ name: '鸡胸肉', amount: '300g', category: 'meat', storageDays: 2 }, { name: '花生米', amount: '50g', category: 'other', storageDays: 90 }],
    steps: ['鸡胸肉切2cm丁，加蛋清淀粉盐腌制15分钟', '调碗汁：醋2勺糖1勺生抽1勺淀粉1勺水2勺', '花生米小火炸至金黄捞出备用', '热锅加油3勺下鸡丁滑散至变白盛出', '锅留底油小火爆香干辣椒花椒20秒', '下鸡丁翻炒30秒，倒入碗汁加花生米出锅'],
    nutrition: { calories: 350, protein: 35, carbs: 15, fat: 18 }, cookTime: 25, difficulty: 'medium', tags: ['川菜', '经典'] },
  { id: 'w10-cold-cucumber', name: '拍黄瓜', type: 'side', season: 'spring', flavor: 'sour',
    ingredients: [{ name: '黄瓜', amount: '2根', category: 'vegetable', storageDays: 7 }],
    steps: ['黄瓜洗净去头尾，用刀面拍松后切成3cm小段', '蒜3瓣切成蒜末', '调味汁：2勺生抽、1勺陈醋、1勺白糖、少许盐混合', '将黄瓜段放入碗中，加入蒜末和调味汁', '淋上1勺红油辣椒，拌匀腌5分钟即可'],
    nutrition: { calories: 40, protein: 1, carbs: 8, fat: 1 }, cookTime: 5, difficulty: 'easy', tags: ['凉菜', '开胃'] },
  { id: 'w10-tomato-egg', name: '番茄炒蛋', type: 'main', season: 'spring', flavor: 'sweet',
    ingredients: [{ name: '番茄', amount: '3个', category: 'vegetable', storageDays: 7 }, { name: '鸡蛋', amount: '4个', category: 'egg', storageDays: 14 }],
    steps: ['番茄划十字开水烫去皮切块', '鸡蛋打散加少许盐搅匀', '热锅加油3勺大火炒蛋至刚凝固盛出', '锅加油1勺下番茄翻炒出汁约2分钟', '加糖1/2勺盐少许调味', '倒入炒蛋翻匀即可出锅'],
    nutrition: { calories: 220, protein: 16, carbs: 15, fat: 12 }, cookTime: 15, difficulty: 'easy', tags: ['经典', '下饭'] },
  { id: 'w10-mushroom-soup', name: '菌菇汤', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '各种菌菇', amount: '300g', category: 'vegetable', storageDays: 5 }],
    steps: ['香菇平菇金针菇等洗净切片撕条', '锅加水4碗烧开', '下菌菇煮10分钟', '加盐1/2茶匙胡椒粉少许调味', '撒葱花香油出锅'],
    nutrition: { calories: 50, protein: 4, carbs: 8, fat: 1 }, cookTime: 20, difficulty: 'easy', tags: ['汤品', '鲜美'] },
  { id: 'w10-braised-beef', name: '土豆炖牛肉', type: 'main', season: 'spring', flavor: 'rich',
    ingredients: [{ name: '牛腩', amount: '500g', category: 'meat', storageDays: 3 }, { name: '土豆', amount: '2个', category: 'vegetable', storageDays: 14 }],
    steps: ['牛腩切3cm块冷水下锅焯水5分钟捞出', '土豆去皮切滚刀块', '热锅加油爆香葱姜八角桂皮', '加牛肉翻炒3分钟', '加生抽3勺老抽1勺料酒2勺', '加开水没过牛肉大火烧开转小火炖1.5小时', '加土豆继续炖30分钟至软烂，大火收汁'],
    nutrition: { calories: 450, protein: 38, carbs: 25, fat: 24 }, cookTime: 120, difficulty: 'medium', tags: ['炖菜', '暖胃'] },
  { id: 'w10-stir-peas', name: '清炒豌豆尖', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '豌豆尖', amount: '400g', category: 'vegetable', storageDays: 2 }],
    steps: ['豌豆尖摘洗干净沥干', '蒜切末备用', '热锅加油2勺大火爆香蒜末10秒', '倒入豌豆尖大火翻炒30秒至微软', '加盐1/3茶匙翻匀出锅'],
    nutrition: { calories: 50, protein: 4, carbs: 6, fat: 2 }, cookTime: 5, difficulty: 'easy', tags: ['时令', '清爽'] },
  { id: 'w10-sweet-sour-ribs', name: '糖醋排骨', type: 'main', season: 'spring', flavor: 'sweet',
    ingredients: [{ name: '肋排', amount: '500g', category: 'meat', storageDays: 3 }],
    steps: ['排骨剁3cm段冷水下锅焯水5分钟去血沫捞出', '调糖醋汁：醋3勺、糖2勺、生抽2勺、番茄酱1勺混合', '热锅加油炒糖色至枣红起泡', '快速下排骨翻炒均匀上色1分钟', '加开水没过排骨，大火烧开转中火焖煮30分钟', '加入糖醋汁大火收汁至浓稠约5分钟', '撒白芝麻出锅装盘'],
    nutrition: { calories: 480, protein: 28, carbs: 22, fat: 32 }, cookTime: 50, difficulty: 'medium', tags: ['经典', '酸甜'] },
  { id: 'w10-garlic-lettuce', name: '蒜蓉生菜', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '生菜', amount: '400g', category: 'vegetable', storageDays: 3 }],
    steps: ['生菜洗净掰成大片沥干', '蒜切末备用', '热锅加油2勺大火爆香蒜末10秒', '快速下生菜大火翻炒30秒至微软', '加盐1/3茶匙蚝油1/2勺翻匀出锅'],
    nutrition: { calories: 50, protein: 2, carbs: 6, fat: 2 }, cookTime: 8, difficulty: 'easy', tags: ['快手', '清淡'] },
  { id: 'w10-fish-sauerkraut', name: '酸菜鱼', type: 'main', season: 'spring', flavor: 'sour',
    ingredients: [{ name: '草鱼', amount: '1条', category: 'seafood', storageDays: 2 }, { name: '酸菜', amount: '200g', category: 'vegetable', storageDays: 30 }],
    steps: ['草鱼片成薄片加蛋清淀粉盐腌制15分钟', '酸菜切丝挤干水分', '热锅加油3勺爆香姜蒜干辣椒花椒30秒', '加酸菜翻炒出香味2分钟', '加开水1升煮开后小火煮10分钟出酸味', '开大火下鱼片快速拨散约30秒变白即熟', '盛入碗中，另起锅烧热油淋在表面'],
    nutrition: { calories: 350, protein: 40, carbs: 8, fat: 18 }, cookTime: 40, difficulty: 'medium', tags: ['川菜', '开胃'] },
  { id: 'w10-stir-tofu', name: '家常豆腐', type: 'side', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '北豆腐', amount: '1块', category: 'tofu', storageDays: 5 }, { name: '五花肉', amount: '100g', category: 'meat', storageDays: 3 }],
    steps: ['北豆腐切1.5cm厚片，五花肉切薄片', '热锅加油3勺中火煎豆腐至两面金黄约5分钟盛出', '锅留底油爆香葱姜蒜和肉片2分钟', '加豆瓣酱1勺炒出红油30秒', '加入豆腐、生抽1勺、水小半碗焖煮3分钟', '大火收汁撒葱花出锅'],
    nutrition: { calories: 280, protein: 18, carbs: 8, fat: 20 }, cookTime: 25, difficulty: 'easy', tags: ['家常', '下饭'] },
]

export const week10Plan: WeeklyPlan = {
  week: 10, month: 3, year: 2026, dateRange: '3月1日(周日) - 3月7日(周六)',
  meals: [
    { date: '3月1日', weekday: '周日', lunch: { main: week10Recipes[0], side: week10Recipes[1], staple: 'rice' }, dinner: { main: week10Recipes[2], side: week10Recipes[3], staple: 'rice' } },
    { date: '3月2日', weekday: '周一', lunch: { main: week10Recipes[4], side: week10Recipes[5], staple: 'rice' }, dinner: { main: week10Recipes[6], side: week10Recipes[7], staple: 'rice' } },
    { date: '3月3日', weekday: '周二', lunch: { main: week10Recipes[8], side: week10Recipes[9], staple: 'rice' }, dinner: { main: week10Recipes[10], side: week10Recipes[11], staple: 'rice' } },
    { date: '3月4日', weekday: '周三', lunch: { main: week10Recipes[12], side: week10Recipes[1], staple: 'rice' }, dinner: { main: week10Recipes[0], side: week10Recipes[3], staple: 'rice' } },
    { date: '3月5日', weekday: '周四', lunch: { main: week10Recipes[2], side: week10Recipes[5], staple: 'rice' }, dinner: { main: week10Recipes[4], side: week10Recipes[7], staple: 'noodle' } },
    { date: '3月6日', weekday: '周五', lunch: { main: week10Recipes[6], side: week10Recipes[9], staple: 'rice' }, dinner: { main: week10Recipes[8], side: week10Recipes[11], staple: 'rice' } },
    { date: '3月7日', weekday: '周六', lunch: { main: week10Recipes[10], side: week10Recipes[1], staple: 'rice' }, dinner: { main: week10Recipes[12], side: week10Recipes[3], staple: 'noodle' } },
  ],
  shoppingList: [
    { name: '五花肉', totalAmount: '700g', category: 'meat', usedIn: ['红烧肉', '家常豆腐'] },
    { name: '牛腩', totalAmount: '500g', category: 'meat', usedIn: ['土豆炖牛肉'] },
    { name: '肋排', totalAmount: '500g', category: 'meat', usedIn: ['糖醋排骨'] },
    { name: '鸡胸肉', totalAmount: '300g', category: 'meat', usedIn: ['宫保鸡丁'] },
    { name: '多宝鱼', totalAmount: '1条', category: 'seafood', usedIn: ['清蒸多宝鱼'] },
    { name: '草鱼', totalAmount: '1条', category: 'seafood', usedIn: ['酸菜鱼'] },
    { name: '北豆腐', totalAmount: '1块', category: 'tofu', usedIn: ['家常豆腐'] },
    { name: '鸡蛋', totalAmount: '4个', category: 'egg', usedIn: ['番茄炒蛋'] },
    { name: '春笋', totalAmount: '400g', category: 'vegetable', usedIn: ['油焖春笋'], buyTip: '春季时令菜' },
    { name: '菠菜', totalAmount: '400g', category: 'vegetable', usedIn: ['蒜蓉菠菜'] },
    { name: '番茄', totalAmount: '3个', category: 'vegetable', usedIn: ['番茄炒蛋'] },
    { name: '黄瓜', totalAmount: '2根', category: 'vegetable', usedIn: ['拍黄瓜'] },
    { name: '土豆', totalAmount: '2个', category: 'vegetable', usedIn: ['土豆炖牛肉'] },
    { name: '豌豆尖', totalAmount: '400g', category: 'vegetable', usedIn: ['清炒豌豆尖'], buyTip: '春季时令菜' },
    { name: '生菜', totalAmount: '400g', category: 'vegetable', usedIn: ['蒜蓉生菜'] },
    { name: '酸菜', totalAmount: '200g', category: 'vegetable', usedIn: ['酸菜鱼'] },
    { name: '菌菇', totalAmount: '300g', category: 'vegetable', usedIn: ['菌菇汤'] },
    { name: '花生米', totalAmount: '50g', category: 'other', usedIn: ['宫保鸡丁'] },
    { name: '大米', totalAmount: '3kg', category: 'staple', usedIn: ['米饭'] },
    { name: '面条', totalAmount: '500g', category: 'staple', usedIn: ['面条'] },
  ],
  totalNutrition: { avgCalories: 1380, avgProtein: 80, avgCarbs: 105, avgFat: 70 }
}

// ========== 第十一周食谱 (3月8日周日 - 3月14日周六) ==========
const week11Recipes: Recipe[] = [
  { id: 'w11-braised-chicken', name: '黄焖鸡', type: 'main', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '三黄鸡', amount: '半只', category: 'meat', storageDays: 2 }, { name: '香菇', amount: '8朵', category: 'vegetable', storageDays: 7 }],
    steps: ['三黄鸡剁3cm块洗净沥干，香菇泡发切半', '热锅加油3勺爆香姜蒜和干辣椒20秒', '下鸡块大火翻炒至变色约3分钟', '加生抽2勺老抽1勺料酒1勺翻匀', '加水没过鸡肉，大火烧开转中火焖煮20分钟', '加香菇继续焖10分钟', '加青椒翻炒2分钟大火收汁出锅'],
    nutrition: { calories: 380, protein: 35, carbs: 10, fat: 22 }, cookTime: 45, difficulty: 'medium', tags: ['家常', '鲜香'] },
  { id: 'w11-cold-spinach', name: '凉拌菠菜', type: 'side', season: 'spring', flavor: 'sour',
    ingredients: [{ name: '菠菜', amount: '400g', category: 'vegetable', storageDays: 3 }],
    steps: ['菠菜去根洗净，切成10cm长段', '烧开水加少许油盐，下菠菜焯烫30秒捞出过凉水', '沥干水分装盘', '蒜切末加生抽2勺醋1勺香油1勺糖少许调成料汁', '淋在菠菜上拌匀，撒花生米即可'],
    nutrition: { calories: 60, protein: 4, carbs: 8, fat: 2 }, cookTime: 10, difficulty: 'easy', tags: ['凉菜', '营养'] },
  { id: 'w11-steamed-eggs', name: '虾仁蒸蛋', type: 'main', season: 'spring', flavor: 'light',
    ingredients: [{ name: '鸡蛋', amount: '3个', category: 'egg', storageDays: 14 }, { name: '虾仁', amount: '100g', category: 'seafood', storageDays: 2 }],
    steps: ['鸡蛋打散加1.5倍温水和少许盐搅匀', '过滤去泡沫', '盖保鲜膜扎几个小孔', '蒸锅水开后中火蒸8分钟', '放入虾仁继续蒸3分钟', '出锅淋生抽半勺香油几滴撒葱花'],
    nutrition: { calories: 200, protein: 18, carbs: 3, fat: 12 }, cookTime: 15, difficulty: 'easy', tags: ['嫩滑', '高蛋白'] },
  { id: 'w11-stir-celery', name: '芹菜炒香干', type: 'side', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '芹菜', amount: '300g', category: 'vegetable', storageDays: 7 }, { name: '香干', amount: '200g', category: 'tofu', storageDays: 5 }],
    steps: ['芹菜去叶切4cm段，香干切条', '热锅加油2勺爆香蒜末10秒', '先下香干翻炒1分钟至微黄', '加芹菜大火翻炒2分钟至断生', '加盐1/3茶匙生抽1/2勺翻匀出锅'],
    nutrition: { calories: 120, protein: 10, carbs: 8, fat: 6 }, cookTime: 10, difficulty: 'easy', tags: ['快手', '家常'] },
  { id: 'w11-mapo-tofu', name: '麻婆豆腐', type: 'main', season: 'spring', flavor: 'spicy',
    ingredients: [{ name: '嫩豆腐', amount: '2块', category: 'tofu', storageDays: 5 }, { name: '猪肉末', amount: '150g', category: 'meat', storageDays: 2 }],
    steps: ['嫩豆腐切2cm方块开水焯1分钟捞出沥干', '热锅加油2勺炒散肉末至变色约2分钟', '加豆瓣酱1勺炒出红油30秒', '加水1碗烧开放入豆腐小火煮3分钟入味', '加生抽1/2勺调味', '水淀粉勾芡撒花椒粉和葱花出锅'],
    nutrition: { calories: 320, protein: 22, carbs: 12, fat: 22 }, cookTime: 20, difficulty: 'easy', tags: ['川菜', '下饭'] },
  { id: 'w11-seaweed-soup', name: '紫菜蛋花汤', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '紫菜', amount: '10g', category: 'vegetable', storageDays: 365 }, { name: '鸡蛋', amount: '2个', category: 'egg', storageDays: 14 }],
    steps: ['紫菜用手撕成小块，鸡蛋打散备用', '锅中加水600ml烧开，放入紫菜煮30秒', '加盐1小勺、少许白胡椒粉调味', '关火后沿锅边缓慢淋入蛋液，静置10秒', '用筷子轻轻搅散形成蛋花，淋少许香油即可'],
    nutrition: { calories: 100, protein: 8, carbs: 3, fat: 6 }, cookTime: 10, difficulty: 'easy', tags: ['汤品', '快手'] },
  { id: 'w11-braised-lamb', name: '红烧羊肉萝卜', type: 'main', season: 'spring', flavor: 'rich',
    ingredients: [{ name: '羊肉', amount: '500g', category: 'meat', storageDays: 3 }, { name: '白萝卜', amount: '1根', category: 'vegetable', storageDays: 14 }],
    steps: ['羊肉切4cm块冷水下锅加姜片料酒焯水5分钟去膻', '白萝卜去皮切滚刀块', '热锅加油炒糖色至枣红色约1分钟', '加羊肉翻炒上色3分钟', '加生抽2勺老抽1勺、八角桂皮香叶', '加开水没过羊肉，大火烧开转小火炖1小时', '加萝卜继续炖30分钟至软烂，大火收汁'],
    nutrition: { calories: 420, protein: 38, carbs: 12, fat: 26 }, cookTime: 100, difficulty: 'medium', tags: ['温补', '滋补'] },
  { id: 'w11-garlic-broccoli', name: '蒜蓉西兰花', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '西兰花', amount: '1颗', category: 'vegetable', storageDays: 7 }],
    steps: ['西兰花切小朵盐水浸泡10分钟洗净', '烧开水加少许油盐焯西兰花2分钟捞出沥干', '蒜切末备用', '热锅加油2勺小火爆香蒜末20秒', '加入西兰花大火翻炒1分钟', '加蚝油1勺、盐少许调味即可出锅'],
    nutrition: { calories: 80, protein: 6, carbs: 8, fat: 3 }, cookTime: 12, difficulty: 'easy', tags: ['清淡', '快手'] },
  { id: 'w11-sweet-sour-fish', name: '糖醋鱼块', type: 'main', season: 'spring', flavor: 'sweet',
    ingredients: [{ name: '草鱼', amount: '1条', category: 'seafood', storageDays: 1 }],
    steps: ['草鱼切3cm块加盐料酒腌制15分钟', '鱼块裹干淀粉', '热锅多油烧至七成热炸鱼块至金黄酥脆约4分钟捞出', '调糖醋汁：番茄酱2勺醋2勺糖2勺生抽1勺淀粉1勺水3勺', '锅留底油炒香葱姜，倒入糖醋汁煮开', '下炸好的鱼块翻匀挂汁出锅'],
    nutrition: { calories: 320, protein: 30, carbs: 25, fat: 12 }, cookTime: 30, difficulty: 'medium', tags: ['酸甜', '宴客'] },
  { id: 'w11-stir-beans', name: '干煸四季豆', type: 'side', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '四季豆', amount: '400g', category: 'vegetable', storageDays: 5 }, { name: '肉末', amount: '50g', category: 'meat', storageDays: 2 }],
    steps: ['四季豆去筋切5cm段洗净沥干', '热锅多油中火炸四季豆至皱皮约5分钟捞出', '锅留底油爆香蒜末姜末和肉末2分钟', '下四季豆加盐1/2茶匙生抽1勺翻炒1分钟', '加少许水焖1分钟大火收干出锅'],
    nutrition: { calories: 120, protein: 8, carbs: 12, fat: 5 }, cookTime: 20, difficulty: 'easy', tags: ['下饭', '家常'] },
  { id: 'w11-pepper-steak', name: '黑椒牛柳', type: 'main', season: 'spring', flavor: 'spicy',
    ingredients: [{ name: '牛里脊', amount: '300g', category: 'meat', storageDays: 3 }],
    steps: ['牛里脊切1cm粗条加蛋清淀粉盐腌制15分钟', '彩椒洋葱切条备用', '热锅加油3勺大火滑散牛肉至变色盛出', '锅加油爆香洋葱1分钟', '下彩椒翻炒30秒', '加牛肉和黑椒汁2勺翻炒均匀出锅'],
    nutrition: { calories: 350, protein: 35, carbs: 8, fat: 20 }, cookTime: 15, difficulty: 'medium', tags: ['西餐', '牛肉'] },
  { id: 'w11-tomato-soup', name: '番茄豆腐汤', type: 'side', season: 'spring', flavor: 'sour',
    ingredients: [{ name: '番茄', amount: '2个', category: 'vegetable', storageDays: 7 }, { name: '豆腐', amount: '1块', category: 'tofu', storageDays: 5 }],
    steps: ['番茄去皮切块，豆腐切1.5cm小方块', '锅中放油烧热，放入番茄块中火炒2分钟至出汁变软', '加入开水500ml，大火煮开后放入豆腐块', '转中火煮5分钟让豆腐入味', '加盐1小勺、少许白胡椒粉调味，撒葱花淋香油出锅'],
    nutrition: { calories: 100, protein: 8, carbs: 10, fat: 4 }, cookTime: 20, difficulty: 'easy', tags: ['汤品', '开胃'] },
  { id: 'w11-twice-cooked', name: '回锅肉', type: 'main', season: 'spring', flavor: 'spicy',
    ingredients: [{ name: '五花肉', amount: '400g', category: 'meat', storageDays: 3 }, { name: '蒜苗', amount: '200g', category: 'vegetable', storageDays: 5 }],
    steps: ['五花肉整块冷水下锅加姜片葱段煮20分钟捞出晾凉', '五花肉切3mm薄片，蒜苗切斜段', '热锅不加油下肉片中火煸至出油卷曲约3分钟', '加豆瓣酱1勺炒出红油30秒', '加豆豉少许甜面酱1/2勺翻炒上色', '下蒜苗大火翻炒1分钟至断生出锅'],
    nutrition: { calories: 450, protein: 22, carbs: 8, fat: 38 }, cookTime: 30, difficulty: 'medium', tags: ['川菜', '下饭'] },
  { id: 'w11-winter-melon', name: '虾皮冬瓜', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '冬瓜', amount: '500g', category: 'vegetable', storageDays: 14 }, { name: '虾皮', amount: '20g', category: 'seafood', storageDays: 90 }],
    steps: ['冬瓜去皮去籽切薄片，虾皮洗净沥干', '热锅加油1勺爆香虾皮30秒', '下冬瓜翻炒1分钟', '加水小半碗盖盖焖煮8分钟至透明', '加盐少许调味撒葱花出锅'],
    nutrition: { calories: 60, protein: 5, carbs: 10, fat: 1 }, cookTime: 15, difficulty: 'easy', tags: ['清淡', '养生'] },
]

export const week11Plan: WeeklyPlan = {
  week: 11, month: 3, year: 2026, dateRange: '3月8日(周日) - 3月14日(周六)',
  meals: [
    { date: '3月8日', weekday: '周日', lunch: { main: week11Recipes[0], side: week11Recipes[1], staple: 'rice' }, dinner: { main: week11Recipes[2], side: week11Recipes[3], staple: 'rice' } },
    { date: '3月9日', weekday: '周一', lunch: { main: week11Recipes[4], side: week11Recipes[5], staple: 'rice' }, dinner: { main: week11Recipes[6], side: week11Recipes[7], staple: 'rice' } },
    { date: '3月10日', weekday: '周二', lunch: { main: week11Recipes[8], side: week11Recipes[9], staple: 'rice' }, dinner: { main: week11Recipes[10], side: week11Recipes[11], staple: 'rice' } },
    { date: '3月11日', weekday: '周三', lunch: { main: week11Recipes[12], side: week11Recipes[1], staple: 'rice' }, dinner: { main: week11Recipes[0], side: week11Recipes[7], staple: 'noodle' } },
    { date: '3月12日', weekday: '周四', lunch: { main: week11Recipes[2], side: week11Recipes[9], staple: 'rice' }, dinner: { main: week11Recipes[4], side: week11Recipes[3], staple: 'rice' } },
    { date: '3月13日', weekday: '周五', lunch: { main: week11Recipes[6], side: week11Recipes[5], staple: 'rice' }, dinner: { main: week11Recipes[8], side: week11Recipes[13], staple: 'rice' } },
    { date: '3月14日', weekday: '周六', lunch: { main: week11Recipes[10], side: week11Recipes[1], staple: 'rice' }, dinner: { main: week11Recipes[12], side: week11Recipes[11], staple: 'noodle' } },
  ],
  shoppingList: [
    { name: '三黄鸡', totalAmount: '半只', category: 'meat', usedIn: ['黄焖鸡'] },
    { name: '五花肉', totalAmount: '400g', category: 'meat', usedIn: ['回锅肉'] },
    { name: '羊肉', totalAmount: '500g', category: 'meat', usedIn: ['红烧羊肉萝卜'] },
    { name: '牛里脊', totalAmount: '300g', category: 'meat', usedIn: ['黑椒牛柳'] },
    { name: '猪肉末', totalAmount: '200g', category: 'meat', usedIn: ['麻婆豆腐', '干煸四季豆'] },
    { name: '草鱼', totalAmount: '1条', category: 'seafood', usedIn: ['糖醋鱼块'] },
    { name: '虾仁', totalAmount: '100g', category: 'seafood', usedIn: ['虾仁蒸蛋'] },
    { name: '虾皮', totalAmount: '20g', category: 'seafood', usedIn: ['虾皮冬瓜'] },
    { name: '嫩豆腐', totalAmount: '2块', category: 'tofu', usedIn: ['麻婆豆腐'] },
    { name: '豆腐', totalAmount: '1块', category: 'tofu', usedIn: ['番茄豆腐汤'] },
    { name: '香干', totalAmount: '200g', category: 'tofu', usedIn: ['芹菜炒香干'] },
    { name: '鸡蛋', totalAmount: '7个', category: 'egg', usedIn: ['虾仁蒸蛋', '紫菜蛋花汤'] },
    { name: '香菇', totalAmount: '8朵', category: 'vegetable', usedIn: ['黄焖鸡'] },
    { name: '芹菜', totalAmount: '300g', category: 'vegetable', usedIn: ['芹菜炒香干'] },
    { name: '白萝卜', totalAmount: '1根', category: 'vegetable', usedIn: ['红烧羊肉萝卜'] },
    { name: '西兰花', totalAmount: '1颗', category: 'vegetable', usedIn: ['蒜蓉西兰花'] },
    { name: '四季豆', totalAmount: '400g', category: 'vegetable', usedIn: ['干煸四季豆'] },
    { name: '番茄', totalAmount: '2个', category: 'vegetable', usedIn: ['番茄豆腐汤'] },
    { name: '蒜苗', totalAmount: '200g', category: 'vegetable', usedIn: ['回锅肉'] },
    { name: '冬瓜', totalAmount: '500g', category: 'vegetable', usedIn: ['虾皮冬瓜'] },
    { name: '菠菜', totalAmount: '400g', category: 'vegetable', usedIn: ['凉拌菠菜'] },
    { name: '紫菜', totalAmount: '10g', category: 'vegetable', usedIn: ['紫菜蛋花汤'] },
    { name: '大米', totalAmount: '3kg', category: 'staple', usedIn: ['米饭'] },
    { name: '面条', totalAmount: '500g', category: 'staple', usedIn: ['面条'] },
  ],
  totalNutrition: { avgCalories: 1350, avgProtein: 78, avgCarbs: 100, avgFat: 68 }
}

// ========== 第十二周食谱 (3月15日周日 - 3月21日周六) ==========
const week12Recipes: Recipe[] = [
  { id: 'w12-cola-chicken', name: '可乐鸡翅', type: 'main', season: 'spring', flavor: 'sweet',
    ingredients: [{ name: '鸡翅', amount: '12个', category: 'meat', storageDays: 2 }, { name: '可乐', amount: '1罐', category: 'other', storageDays: 180 }],
    steps: ['鸡翅洗净两面各划2刀方便入味', '热锅加油2勺中火煎鸡翅至两面金黄约5分钟', '加姜片生抽1勺老抽1/2勺翻炒上色', '倒入可乐没过鸡翅大火烧开', '转中小火焖煮15分钟', '开大火收汁至浓稠油亮撒芝麻出锅'],
    nutrition: { calories: 350, protein: 28, carbs: 20, fat: 18 }, cookTime: 30, difficulty: 'easy', tags: ['简单', '孩子爱吃'] },
  { id: 'w12-stir-yam', name: '清炒山药木耳', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '山药', amount: '300g', category: 'vegetable', storageDays: 14 }, { name: '黑木耳', amount: '50g(干)', category: 'vegetable', storageDays: 365 }],
    steps: ['木耳提前泡发2小时洗净撕小朵', '山药去皮切3mm薄片泡醋水防氧化', '胡萝卜切菱形片', '热锅加油2勺爆香蒜末10秒', '先下胡萝卜翻炒1分钟', '加山药木耳大火翻炒2分钟', '加盐1/2茶匙、鸡精少许调味出锅'],
    nutrition: { calories: 120, protein: 4, carbs: 25, fat: 2 }, cookTime: 15, difficulty: 'easy', tags: ['清淡', '养生'] },
  { id: 'w12-steamed-ribs', name: '豆豉蒸排骨', type: 'main', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '排骨', amount: '500g', category: 'meat', storageDays: 3 }],
    steps: ['排骨剁小块洗净沥干', '加生抽1勺料酒1勺淀粉1勺蒜末姜末腌20分钟', '加豆豉1勺拌匀', '放入盘中铺平', '蒸锅水开后大火蒸25分钟', '出锅撒葱花红辣椒圈'],
    nutrition: { calories: 400, protein: 28, carbs: 5, fat: 30 }, cookTime: 35, difficulty: 'easy', tags: ['蒸菜', '广式'] },
  { id: 'w12-cabbage-soup', name: '白菜豆腐汤', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '大白菜', amount: '300g', category: 'vegetable', storageDays: 14 }, { name: '豆腐', amount: '1块', category: 'tofu', storageDays: 5 }],
    steps: ['大白菜洗净切块，豆腐切2cm方块', '锅加水4碗烧开', '下白菜煮3分钟至软', '加豆腐煮2分钟', '加盐1/2茶匙胡椒粉少许调味', '撒葱花香油出锅'],
    nutrition: { calories: 80, protein: 8, carbs: 8, fat: 2 }, cookTime: 20, difficulty: 'easy', tags: ['汤品', '清淡'] },
  { id: 'w12-fish-flavored', name: '鱼香肉丝', type: 'main', season: 'spring', flavor: 'sweet',
    ingredients: [{ name: '猪里脊', amount: '300g', category: 'meat', storageDays: 3 }, { name: '木耳', amount: '50g', category: 'vegetable', storageDays: 365 }, { name: '胡萝卜', amount: '1根', category: 'vegetable', storageDays: 14 }],
    steps: ['猪里脊切丝加蛋清淀粉盐腌制10分钟', '木耳泡发切丝，胡萝卜切丝', '调鱼香汁：醋2勺糖1.5勺生抽1勺淀粉1勺水2勺', '热锅加油3勺滑散肉丝至变白盛出', '锅加油爆香泡椒和蒜末姜末30秒', '下配菜翻炒1分钟加肉丝', '倒入鱼香汁翻炒至浓稠出锅'],
    nutrition: { calories: 320, protein: 28, carbs: 18, fat: 16 }, cookTime: 25, difficulty: 'medium', tags: ['川菜', '经典'] },
  { id: 'w12-egg-soup', name: '西红柿蛋汤', type: 'side', season: 'spring', flavor: 'sweet',
    ingredients: [{ name: '番茄', amount: '2个', category: 'vegetable', storageDays: 7 }, { name: '鸡蛋', amount: '2个', category: 'egg', storageDays: 14 }],
    steps: ['番茄划十字开水烫去皮切小块', '鸡蛋打散备用', '热锅加油1勺炒番茄至出汁约2分钟', '加水3碗大火煮开', '加盐1/2茶匙调味', '关火用筷子搅动汤水同时淋入蛋液', '撒葱花和香油几滴出锅'],
    nutrition: { calories: 100, protein: 8, carbs: 8, fat: 5 }, cookTime: 15, difficulty: 'easy', tags: ['汤品', '开胃'] },
  { id: 'w12-braised-carp', name: '红烧鲤鱼', type: 'main', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '鲤鱼', amount: '1条', category: 'seafood', storageDays: 1 }],
    steps: ['鲤鱼去鳞去内脏洗净，两面划3刀方便入味', '鱼身抹盐和料酒腌制10分钟', '热锅加油4勺中火煎鱼至两面金黄约5分钟', '加葱姜蒜、生抽2勺、老抽1勺、料酒1勺、糖1/2勺', '加水没过鱼身大火烧开转小火焖15分钟', '大火收汁至浓稠撒葱花出锅'],
    nutrition: { calories: 220, protein: 28, carbs: 5, fat: 10 }, cookTime: 35, difficulty: 'medium', tags: ['红烧', '鲜美'] },
  { id: 'w12-cucumber-wood-ear', name: '黄瓜炒木耳', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '黄瓜', amount: '2根', category: 'vegetable', storageDays: 7 }, { name: '木耳', amount: '50g', category: 'vegetable', storageDays: 365 }],
    steps: ['木耳提前泡发2小时洗净撕小朵', '黄瓜斜切薄片', '热锅加油2勺爆香蒜末10秒', '先下木耳翻炒1分钟', '加黄瓜大火翻炒1分钟', '加盐1/3茶匙调味出锅'],
    nutrition: { calories: 60, protein: 3, carbs: 10, fat: 1 }, cookTime: 10, difficulty: 'easy', tags: ['清爽', '快手'] },
  { id: 'w12-curry-chicken', name: '咖喱鸡', type: 'main', season: 'spring', flavor: 'rich',
    ingredients: [{ name: '鸡腿', amount: '3个', category: 'meat', storageDays: 2 }, { name: '土豆', amount: '2个', category: 'vegetable', storageDays: 14 }],
    steps: ['鸡腿剔骨切3cm块，用料酒、盐腌制15分钟', '土豆去皮切滚刀块，胡萝卜切块，洋葱切丁', '锅中放油烧热，下鸡块中火煎至两面金黄约5分钟', '加入洋葱丁炒出香味，放入咖喱块2块炒化', '加入土豆、胡萝卜和开水没过食材，大火烧开', '转小火焖煮25分钟至土豆软烂，汤汁浓稠即可'],
    nutrition: { calories: 420, protein: 35, carbs: 25, fat: 22 }, cookTime: 45, difficulty: 'medium', tags: ['异域', '浓郁'] },
  { id: 'w12-corn-soup', name: '玉米排骨汤', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '排骨', amount: '300g', category: 'meat', storageDays: 3 }, { name: '玉米', amount: '2根', category: 'vegetable', storageDays: 7 }],
    steps: ['排骨剁小块冷水下锅焯水5分钟捞出洗净', '玉米切段', '砂锅加排骨姜片和开水没过食材', '大火烧开转小火炖40分钟', '加玉米继续炖20分钟', '加盐1茶匙调味撒葱花出锅'],
    nutrition: { calories: 180, protein: 15, carbs: 15, fat: 8 }, cookTime: 70, difficulty: 'easy', tags: ['汤品', '滋补'] },
  { id: 'w12-pork-green-pepper', name: '青椒肉丝', type: 'main', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '猪里脊', amount: '250g', category: 'meat', storageDays: 3 }, { name: '青椒', amount: '3个', category: 'vegetable', storageDays: 7 }],
    steps: ['猪里脊切丝加蛋清淀粉盐腌制10分钟', '青椒去籽切丝', '热锅加油3勺下肉丝滑散至变白盛出', '锅加油1勺下青椒大火翻炒1分钟至断生', '下肉丝加生抽1勺盐少许翻炒30秒出锅'],
    nutrition: { calories: 280, protein: 25, carbs: 8, fat: 17 }, cookTime: 15, difficulty: 'easy', tags: ['快手', '下饭'] },
  { id: 'w12-cold-bean-sprouts', name: '清炒绿豆芽', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '绿豆芽', amount: '400g', category: 'vegetable', storageDays: 2 }],
    steps: ['绿豆芽掐去根须洗净沥干', '热锅加油2勺大火爆香蒜末10秒', '快速倒入豆芽大火翻炒1分钟', '加醋1勺盐1/3茶匙翻炒30秒', '撒葱花出锅不可炒太久'],
    nutrition: { calories: 40, protein: 4, carbs: 6, fat: 1 }, cookTime: 5, difficulty: 'easy', tags: ['快手', '爽脆'] },
  { id: 'w12-lion-head', name: '红烧狮子头', type: 'main', season: 'spring', flavor: 'rich',
    ingredients: [{ name: '猪肉馅', amount: '500g', category: 'meat', storageDays: 2 }, { name: '荸荠', amount: '5个', category: 'vegetable', storageDays: 14 }],
    steps: ['猪肉馅加切碎荸荠、葱姜末、蛋清1个、盐1茶匙、生抽1勺顺一个方向搅打上劲', '手沾水取肉馅搓成直径5cm的大丸子约4个', '热锅加油4勺中火煎丸子至四面金黄约5分钟', '加生抽2勺老抽1勺糖1/2勺和开水没过丸子', '大火烧开转小火焖煮30分钟至软烂', '大火收汁撒葱花出锅'],
    nutrition: { calories: 480, protein: 30, carbs: 15, fat: 35 }, cookTime: 50, difficulty: 'medium', tags: ['经典', '宴客'] },
  { id: 'w12-garlic-water-spinach', name: '蒜蓉空心菜', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '空心菜', amount: '400g', category: 'vegetable', storageDays: 2 }],
    steps: ['空心菜掐去老梗洗净沥干切段', '蒜切末备用', '热锅加油2勺大火爆香蒜末10秒', '倒入空心菜大火翻炒1分钟至微软', '加盐1/3茶匙鸡精少许翻炒均匀出锅'],
    nutrition: { calories: 50, protein: 3, carbs: 6, fat: 2 }, cookTime: 8, difficulty: 'easy', tags: ['快手', '清爽'] },
]

export const week12Plan: WeeklyPlan = {
  week: 12, month: 3, year: 2026, dateRange: '3月15日(周日) - 3月21日(周六)',
  meals: [
    { date: '3月15日', weekday: '周日', lunch: { main: week12Recipes[0], side: week12Recipes[1], staple: 'rice' }, dinner: { main: week12Recipes[2], side: week12Recipes[3], staple: 'rice' } },
    { date: '3月16日', weekday: '周一', lunch: { main: week12Recipes[4], side: week12Recipes[5], staple: 'rice' }, dinner: { main: week12Recipes[6], side: week12Recipes[7], staple: 'rice' } },
    { date: '3月17日', weekday: '周二', lunch: { main: week12Recipes[8], side: week12Recipes[9], staple: 'rice' }, dinner: { main: week12Recipes[10], side: week12Recipes[11], staple: 'noodle' } },
    { date: '3月18日', weekday: '周三', lunch: { main: week12Recipes[12], side: week12Recipes[1], staple: 'rice' }, dinner: { main: week12Recipes[0], side: week12Recipes[7], staple: 'rice' } },
    { date: '3月19日', weekday: '周四', lunch: { main: week12Recipes[2], side: week12Recipes[5], staple: 'rice' }, dinner: { main: week12Recipes[4], side: week12Recipes[3], staple: 'rice' } },
    { date: '3月20日', weekday: '周五', lunch: { main: week12Recipes[6], side: week12Recipes[9], staple: 'rice' }, dinner: { main: week12Recipes[8], side: week12Recipes[13], staple: 'rice' } },
    { date: '3月21日', weekday: '周六', lunch: { main: week12Recipes[10], side: week12Recipes[1], staple: 'rice' }, dinner: { main: week12Recipes[12], side: week12Recipes[11], staple: 'noodle' } },
  ],
  shoppingList: [
    { name: '鸡翅', totalAmount: '12个', category: 'meat', usedIn: ['可乐鸡翅'] },
    { name: '排骨', totalAmount: '800g', category: 'meat', usedIn: ['豆豉蒸排骨', '玉米排骨汤'] },
    { name: '猪里脊', totalAmount: '550g', category: 'meat', usedIn: ['鱼香肉丝', '青椒肉丝'] },
    { name: '猪肉馅', totalAmount: '500g', category: 'meat', usedIn: ['红烧狮子头'] },
    { name: '鸡腿', totalAmount: '3个', category: 'meat', usedIn: ['咖喱鸡'] },
    { name: '鲤鱼', totalAmount: '1条', category: 'seafood', usedIn: ['红烧鲤鱼'] },
    { name: '豆腐', totalAmount: '2块', category: 'tofu', usedIn: ['白菜豆腐汤'] },
    { name: '鸡蛋', totalAmount: '4个', category: 'egg', usedIn: ['西红柿蛋汤'] },
    { name: '山药', totalAmount: '300g', category: 'vegetable', usedIn: ['清炒山药木耳'] },
    { name: '黑木耳', totalAmount: '100g', category: 'vegetable', usedIn: ['清炒山药木耳', '鱼香肉丝'] },
    { name: '大白菜', totalAmount: '300g', category: 'vegetable', usedIn: ['白菜豆腐汤'] },
    { name: '番茄', totalAmount: '2个', category: 'vegetable', usedIn: ['西红柿蛋汤'] },
    { name: '黄瓜', totalAmount: '2根', category: 'vegetable', usedIn: ['黄瓜炒木耳'] },
    { name: '土豆', totalAmount: '2个', category: 'vegetable', usedIn: ['咖喱鸡'] },
    { name: '玉米', totalAmount: '2根', category: 'vegetable', usedIn: ['玉米排骨汤'] },
    { name: '青椒', totalAmount: '3个', category: 'vegetable', usedIn: ['青椒肉丝'] },
    { name: '绿豆芽', totalAmount: '400g', category: 'vegetable', usedIn: ['清炒绿豆芽'] },
    { name: '荸荠', totalAmount: '5个', category: 'vegetable', usedIn: ['红烧狮子头'] },
    { name: '空心菜', totalAmount: '400g', category: 'vegetable', usedIn: ['蒜蓉空心菜'] },
    { name: '胡萝卜', totalAmount: '1根', category: 'vegetable', usedIn: ['鱼香肉丝'] },
    { name: '可乐', totalAmount: '1罐', category: 'other', usedIn: ['可乐鸡翅'] },
    { name: '大米', totalAmount: '3kg', category: 'staple', usedIn: ['米饭'] },
    { name: '面条', totalAmount: '500g', category: 'staple', usedIn: ['面条'] },
  ],
  totalNutrition: { avgCalories: 1380, avgProtein: 80, avgCarbs: 108, avgFat: 72 }
}

// ========== 第十三周食谱 (3月22日周日 - 3月31日周二) ==========
const week13Recipes: Recipe[] = [
  { id: 'w13-braised-tofu', name: '红烧日本豆腐', type: 'main', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '日本豆腐', amount: '4条', category: 'tofu', storageDays: 7 }],
    steps: ['日本豆腐从包装取出切2cm厚段', '热锅加油3勺中火煎豆腐至两面金黄约3分钟', '小心翻面避免碎裂', '调汁：生抽1勺蚝油1勺糖少许水3勺淀粉1/2勺', '倒入调料汁中火烧开煮2分钟至汤汁浓稠', '撒葱花出锅'],
    nutrition: { calories: 200, protein: 10, carbs: 15, fat: 12 }, cookTime: 20, difficulty: 'easy', tags: ['嫩滑', '下饭'] },
  { id: 'w13-carrot-corn-soup', name: '胡萝卜玉米汤', type: 'side', season: 'spring', flavor: 'sweet',
    ingredients: [{ name: '胡萝卜', amount: '2根', category: 'vegetable', storageDays: 14 }, { name: '玉米', amount: '1根', category: 'vegetable', storageDays: 7 }],
    steps: ['胡萝卜去皮切滚刀块，玉米切段', '锅加水1升放入胡萝卜玉米和姜片', '大火烧开转小火煮40分钟', '加盐少许调味即可出锅'],
    nutrition: { calories: 80, protein: 3, carbs: 18, fat: 1 }, cookTime: 60, difficulty: 'easy', tags: ['汤品', '甜'] },
  { id: 'w13-steamed-sea-bass', name: '清蒸鲈鱼', type: 'main', season: 'spring', flavor: 'light',
    ingredients: [{ name: '鲈鱼', amount: '1条', category: 'seafood', storageDays: 1 }],
    steps: ['鲈鱼去鳞去内脏洗净，在鱼身两面各划3刀便于入味', '用料酒1勺抹遍鱼身内外去腥，腌制10分钟', '盘底铺葱段姜片，鱼身上也放葱姜丝', '蒸锅水开后放入鱼，大火蒸8-9分钟', '取出倒掉蒸鱼水，捡去旧葱姜，重新铺上新鲜葱丝', '淋2勺蒸鱼豉油，烧热3勺油泼在葱丝上激发香味'],
    nutrition: { calories: 180, protein: 32, carbs: 2, fat: 5 }, cookTime: 20, difficulty: 'easy', tags: ['清淡', '高蛋白'] },
  { id: 'w13-garlic-bok-choy', name: '蒜蓉青菜', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '小青菜', amount: '400g', category: 'vegetable', storageDays: 3 }],
    steps: ['小青菜掰开洗净沥干，蒜4瓣切成蒜末', '锅中放油烧至七成热，先下一半蒜末爆香10秒', '立即放入青菜大火快炒，翻炒约1分钟至叶片变软', '加盐半小勺、少许鸡精调味', '出锅前撒入剩余蒜末增加蒜香，翻匀即可装盘'],
    nutrition: { calories: 45, protein: 3, carbs: 6, fat: 1 }, cookTime: 8, difficulty: 'easy', tags: ['快手', '清淡'] },
  { id: 'w13-salt-pepper-shrimp', name: '椒盐虾', type: 'main', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '基围虾', amount: '500g', category: 'seafood', storageDays: 1 }],
    steps: ['基围虾剪须去虾线洗净沥干', '加少许盐和料酒腌5分钟', '热锅加油烧至七成热约180度', '下虾炸至壳酥脆约3分钟捞出', '锅留少许底油爆香蒜末姜末10秒', '加炸好的虾翻炒30秒', '撒椒盐粉和葱花翻匀出锅'],
    nutrition: { calories: 250, protein: 35, carbs: 5, fat: 10 }, cookTime: 20, difficulty: 'easy', tags: ['宴客', '酥脆'] },
  { id: 'w13-cold-tofu', name: '皮蛋豆腐', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '内酯豆腐', amount: '1盒', category: 'tofu', storageDays: 7 }, { name: '皮蛋', amount: '2个', category: 'egg', storageDays: 30 }],
    steps: ['内酯豆腐倒扣切块摆盘', '皮蛋剥壳切成6瓣摆在豆腐周围', '蒜切末、香菜切碎', '调汁：生抽2勺醋1勺香油1勺蒜末拌匀', '淋在豆腐皮蛋上', '撒香菜即可'],
    nutrition: { calories: 150, protein: 12, carbs: 5, fat: 10 }, cookTime: 5, difficulty: 'easy', tags: ['凉菜', '简单'] },
  { id: 'w13-braised-pork-ribs', name: '红烧排骨', type: 'main', season: 'spring', flavor: 'rich',
    ingredients: [{ name: '排骨', amount: '500g', category: 'meat', storageDays: 3 }],
    steps: ['排骨斩小段冷水下锅，加料酒焯水5分钟捞出洗净', '锅中放油和冰糖30g，小火炒至焦糖色', '放入排骨快速翻炒上色，加入葱段、姜片、八角2个、桂皮1小块', '加2勺生抽、1勺老抽、1勺料酒，翻炒均匀', '加开水没过排骨，大火烧开转小火焖煮45分钟', '大火收汁至浓稠挂在排骨上，撒葱花装盘'],
    nutrition: { calories: 450, protein: 30, carbs: 10, fat: 32 }, cookTime: 60, difficulty: 'medium', tags: ['经典', '下饭'] },
  { id: 'w13-hot-sour-shreds', name: '酸辣土豆丝', type: 'side', season: 'spring', flavor: 'sour',
    ingredients: [{ name: '土豆', amount: '2个', category: 'vegetable', storageDays: 14 }, { name: '干辣椒', amount: '5个', category: 'seasoning', storageDays: 365 }],
    steps: ['土豆去皮切细丝泡水10分钟洗去淀粉沥干', '干辣椒切段、蒜切片', '热锅加油2勺小火爆香辣椒花椒蒜片15秒', '开大火倒入土豆丝快速翻炒2分钟', '加醋2勺、盐1/3茶匙翻炒均匀', '撒葱花出锅'],
    nutrition: { calories: 100, protein: 2, carbs: 20, fat: 2 }, cookTime: 12, difficulty: 'easy', tags: ['开胃', '下饭'] },
  { id: 'w13-shredded-pork', name: '京酱肉丝', type: 'main', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '猪里脊', amount: '300g', category: 'meat', storageDays: 3 }],
    steps: ['猪里脊切成5cm长的细丝，加1勺料酒、半勺淀粉、少许盐腌制15分钟', '大葱白切10cm长丝，豆腐皮或荷叶饼准备好', '锅中宽油烧至五成热，下肉丝滑散变色后捞出沥油', '锅留底油，放入2大勺甜面酱、1勺白糖，小火炒出香味', '倒入肉丝快速翻炒裹匀酱汁约30秒', '装盘后铺上葱丝，用豆腐皮卷着肉丝和葱丝吃'],
    nutrition: { calories: 340, protein: 28, carbs: 12, fat: 20 }, cookTime: 20, difficulty: 'easy', tags: ['京菜', '经典'] },
  { id: 'w13-stir-snow-peas', name: '清炒荷兰豆', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '荷兰豆', amount: '300g', category: 'vegetable', storageDays: 5 }],
    steps: ['荷兰豆去两头老筋，洗净沥干', '蒜3瓣切片，准备姜丝少许', '锅中放油烧至七成热，下蒜片姜丝爆香10秒', '立即放入荷兰豆大火快炒，不停翻炒约2分钟至断生变色', '加盐半小勺、少许鸡精调味，翻炒均匀即可出锅'],
    nutrition: { calories: 60, protein: 4, carbs: 8, fat: 2 }, cookTime: 8, difficulty: 'easy', tags: ['清爽', '快手'] },
  { id: 'w13-dumplings', name: '猪肉白菜饺子', type: 'main', season: 'spring', flavor: 'salty',
    ingredients: [{ name: '猪肉馅', amount: '400g', category: 'meat', storageDays: 2 }, { name: '大白菜', amount: '500g', category: 'vegetable', storageDays: 14 }],
    steps: ['白菜剁碎撒盐腌10分钟挤干水分', '肉馅加葱姜末生抽料酒盐香油顺时针搅打上劲', '加白菜碎拌匀成馅', '取饺子皮包入馅料捏紧', '水开下饺子煮至浮起再煮2分钟', '捞出蘸醋蒜汁食用'],
    nutrition: { calories: 450, protein: 25, carbs: 45, fat: 20 }, cookTime: 60, difficulty: 'medium', tags: ['面食', '家常'] },
  { id: 'w13-vinegar-peanuts', name: '老醋花生', type: 'side', season: 'spring', flavor: 'sour',
    ingredients: [{ name: '花生米', amount: '200g', category: 'other', storageDays: 90 }],
    steps: ['花生米冷油下锅小火炸至酥脆金黄约5分钟捞出晾凉', '洋葱青红椒切小丁', '调汁：醋3勺糖2勺生抽1勺香油1勺', '花生米加蔬菜丁和调料汁拌匀', '撒香菜即可'],
    nutrition: { calories: 200, protein: 8, carbs: 10, fat: 15 }, cookTime: 15, difficulty: 'easy', tags: ['下酒', '开胃'] },
  { id: 'w13-spicy-chicken', name: '辣子鸡', type: 'main', season: 'spring', flavor: 'spicy',
    ingredients: [{ name: '鸡腿', amount: '3个', category: 'meat', storageDays: 2 }, { name: '干辣椒', amount: '50g', category: 'seasoning', storageDays: 365 }],
    steps: ['鸡肉切块腌制', '油炸酥脆', '爆香辣椒花椒', '加鸡块翻炒'],
    nutrition: { calories: 420, protein: 32, carbs: 12, fat: 28 }, cookTime: 35, difficulty: 'medium', tags: ['川菜', '香辣'] },
  { id: 'w13-radish-ribs-soup', name: '萝卜排骨汤', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '排骨', amount: '300g', category: 'meat', storageDays: 3 }, { name: '白萝卜', amount: '1根', category: 'vegetable', storageDays: 14 }],
    steps: ['排骨冷水下锅焯水3分钟', '萝卜去皮切滚刀块', '排骨加姜片炖40分钟', '加萝卜再炖20分钟', '加盐调味即可'],
    nutrition: { calories: 160, protein: 14, carbs: 10, fat: 8 }, cookTime: 70, difficulty: 'easy', tags: ['汤品', '滋补'] },
  { id: 'w13-eggplant-pot', name: '鱼香茄子', type: 'main', season: 'spring', flavor: 'sweet',
    ingredients: [{ name: '茄子', amount: '3根', category: 'vegetable', storageDays: 5 }, { name: '猪肉末', amount: '100g', category: 'meat', storageDays: 2 }],
    steps: ['茄子切滚刀块撒盐腌10分钟挤水', '调鱼香汁：醋2勺糖1.5勺生抽1勺淀粉1勺水2勺', '热锅多油炸茄子至金黄软烂约3分钟捞出', '锅留底油炒散肉末2分钟', '加豆瓣酱1勺蒜末姜末炒香', '下茄子翻炒倒入鱼香汁收汁出锅'],
    nutrition: { calories: 280, protein: 12, carbs: 25, fat: 16 }, cookTime: 25, difficulty: 'medium', tags: ['川菜', '下饭'] },
  { id: 'w13-egg-drop-soup', name: '鸡蛋羹', type: 'side', season: 'spring', flavor: 'light',
    ingredients: [{ name: '鸡蛋', amount: '3个', category: 'egg', storageDays: 14 }],
    steps: ['鸡蛋打散加1.5倍温水和少许盐搅匀', '过滤去泡沫', '盖保鲜膜扎几个小孔', '蒸锅水开后中火蒸12分钟', '出锅淋生抽1/2勺香油几滴', '撒葱花即可'],
    nutrition: { calories: 150, protein: 12, carbs: 2, fat: 10 }, cookTime: 15, difficulty: 'easy', tags: ['嫩滑', '营养'] },
]

export const week13Plan: WeeklyPlan = {
  week: 13, month: 3, year: 2026, dateRange: '3月22日(周日) - 3月31日(周二)',
  meals: [
    { date: '3月22日', weekday: '周日', lunch: { main: week13Recipes[0], side: week13Recipes[1], staple: 'rice' }, dinner: { main: week13Recipes[2], side: week13Recipes[3], staple: 'rice' } },
    { date: '3月23日', weekday: '周一', lunch: { main: week13Recipes[4], side: week13Recipes[5], staple: 'rice' }, dinner: { main: week13Recipes[6], side: week13Recipes[7], staple: 'rice' } },
    { date: '3月24日', weekday: '周二', lunch: { main: week13Recipes[8], side: week13Recipes[9], staple: 'noodle' }, dinner: { main: week13Recipes[10], side: week13Recipes[11], staple: 'both' } },
    { date: '3月25日', weekday: '周三', lunch: { main: week13Recipes[12], side: week13Recipes[1], staple: 'rice' }, dinner: { main: week13Recipes[0], side: week13Recipes[3], staple: 'rice' } },
    { date: '3月26日', weekday: '周四', lunch: { main: week13Recipes[2], side: week13Recipes[7], staple: 'rice' }, dinner: { main: week13Recipes[4], side: week13Recipes[5], staple: 'rice' } },
    { date: '3月27日', weekday: '周五', lunch: { main: week13Recipes[6], side: week13Recipes[9], staple: 'rice' }, dinner: { main: week13Recipes[8], side: week13Recipes[13], staple: 'rice' } },
    { date: '3月28日', weekday: '周六', lunch: { main: week13Recipes[10], side: week13Recipes[1], staple: 'both' }, dinner: { main: week13Recipes[12], side: week13Recipes[11], staple: 'rice' } },
    { date: '3月29日', weekday: '周日', lunch: { main: week13Recipes[0], side: week13Recipes[9], staple: 'rice' }, dinner: { main: week13Recipes[2], side: week13Recipes[15], staple: 'rice' } },
    { date: '3月30日', weekday: '周一', lunch: { main: week13Recipes[4], side: week13Recipes[3], staple: 'rice' }, dinner: { main: week13Recipes[6], side: week13Recipes[7], staple: 'noodle' } },
    { date: '3月31日', weekday: '周二', lunch: { main: week13Recipes[14], side: week13Recipes[15], staple: 'rice' }, dinner: { main: week13Recipes[8], side: week13Recipes[5], staple: 'rice' } },
  ],
  shoppingList: [
    { name: '排骨', totalAmount: '800g', category: 'meat', usedIn: ['红烧排骨', '萝卜排骨汤'] },
    { name: '猪里脊', totalAmount: '300g', category: 'meat', usedIn: ['京酱肉丝'] },
    { name: '猪肉馅', totalAmount: '500g', category: 'meat', usedIn: ['猪肉白菜饺子', '鱼香茄子'] },
    { name: '鸡腿', totalAmount: '6个', category: 'meat', usedIn: ['辣子鸡'] },
    { name: '基围虾', totalAmount: '500g', category: 'seafood', usedIn: ['椒盐虾'] },
    { name: '鲈鱼', totalAmount: '1条', category: 'seafood', usedIn: ['清蒸鲈鱼'] },
    { name: '日本豆腐', totalAmount: '4条', category: 'tofu', usedIn: ['红烧日本豆腐'] },
    { name: '内酯豆腐', totalAmount: '1盒', category: 'tofu', usedIn: ['皮蛋豆腐'] },
    { name: '皮蛋', totalAmount: '2个', category: 'egg', usedIn: ['皮蛋豆腐'] },
    { name: '鸡蛋', totalAmount: '9个', category: 'egg', usedIn: ['鸡蛋羹'] },
    { name: '胡萝卜', totalAmount: '2根', category: 'vegetable', usedIn: ['胡萝卜玉米汤'] },
    { name: '玉米', totalAmount: '1根', category: 'vegetable', usedIn: ['胡萝卜玉米汤'] },
    { name: '小青菜', totalAmount: '400g', category: 'vegetable', usedIn: ['蒜蓉青菜'] },
    { name: '土豆', totalAmount: '2个', category: 'vegetable', usedIn: ['酸辣土豆丝'] },
    { name: '荷兰豆', totalAmount: '300g', category: 'vegetable', usedIn: ['清炒荷兰豆'] },
    { name: '大白菜', totalAmount: '500g', category: 'vegetable', usedIn: ['猪肉白菜饺子'] },
    { name: '白萝卜', totalAmount: '1根', category: 'vegetable', usedIn: ['萝卜排骨汤'] },
    { name: '茄子', totalAmount: '3根', category: 'vegetable', usedIn: ['鱼香茄子'] },
    { name: '花生米', totalAmount: '200g', category: 'other', usedIn: ['老醋花生'] },
    { name: '饺子皮', totalAmount: '500g', category: 'staple', usedIn: ['饺子'] },
    { name: '大米', totalAmount: '3kg', category: 'staple', usedIn: ['米饭'] },
    { name: '面条', totalAmount: '500g', category: 'staple', usedIn: ['面条'] },
  ],
  totalNutrition: { avgCalories: 1380, avgProtein: 78, avgCarbs: 108, avgFat: 70 }
}

// 导出所有三月计划
export const marchWeeklyPlans: WeeklyPlan[] = [week10Plan, week11Plan, week12Plan, week13Plan]
export const allWeeklyPlans: WeeklyPlan[] = [...januaryWeeklyPlans, ...februaryWeeklyPlans, ...marchWeeklyPlans]
export const allRecipes = [...week1Recipes, ...week2Recipes, ...week3Recipes, ...week4Recipes, ...week5Recipes, ...week6Recipes, ...week7Recipes, ...week8Recipes, ...week9Recipes, ...week10Recipes, ...week11Recipes, ...week12Recipes, ...week13Recipes]
